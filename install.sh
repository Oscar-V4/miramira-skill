...
Installs skills/miramira into:
  codex  -> ${CODEX_HOME:-$HOME/.codex}/skills/miramira
  claude -> $HOME/.claude/skills/miramira
EOF
}
...
skill_src="$repo_root/skills/miramira"
...
echo "Installed miramira to $dest"
